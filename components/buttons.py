...
class RoundButton(QPushButton):
    def __init__(
        ...
        self.setStyleSheet(f"border-radius: {self.fixed_size//2}px; font-size: 20px; font-weight: bold;")


class BackButton(RoundButton):
    def __init__(self, parent=None, fixed_size=30):
...
class PlayPauseButton(RoundButton):
    def __init__(self, parent=None, fixed_size=50, 
